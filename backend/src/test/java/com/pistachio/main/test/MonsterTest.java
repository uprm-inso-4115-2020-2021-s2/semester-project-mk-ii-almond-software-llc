...
class MonsterTest {
	...
	static ArrayList<Object> moves = new ArrayList<Object>();
	static ArrayList<Object> stats= new ArrayList<Object>();
	...
	static void Setup() {
		...
		//Create the monsters
		Chopo = new Monster("chopo", "Chopo", moves, stats);
		ShinyChopo = new Monster("11230", "chopo", "Chopo", "igtampe", moves, stats);
