...
public class Battle {
    ...
    public void setPlayer1Action(String newAction) {this.player1Action = newAction;}
    public void setPlayer2Action(String newAction) {this.player2Action = newAction;}
    ...
    public void calculateTurnOutcome() {
        ...
        if(player1Action != "" && player2Action != "")
        {
            ...
            {
                calculateDamage(player1Action.charAt(1), player2Action.charAt(1));
            }
        }
    }
